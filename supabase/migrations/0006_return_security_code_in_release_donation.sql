-- 0006_return_security_code_in_release_donation.sql

BEGIN;

-- Recria a função release_donation para atribuir security_code corretamente
...
BEGIN
  ...
  -- 4) Insere a doação, retornando ID e código
  ...
  -- 7) Retorna linha final com os dois campos preenchidos
  RETURN NEXT;
END;
