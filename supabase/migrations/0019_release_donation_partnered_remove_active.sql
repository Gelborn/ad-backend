-- 20250806_release_donation_partnered_remove_active.sql
...
BEGIN
  ...
  -- 3) Escolhe OSC parceira (favorita primeiro;
  --    depois quem recebeu há mais tempo)
  WITH last_don AS (
    SELECT
      pt.osc_id,
      pt.is_favorite,
  ...
  -- 5) Insere a doação (status 'pending')
